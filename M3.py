...
def Gompertz_model_cumulative(t, a, b, c):
    return a * c * np.exp (-b * t)
...
failures_predictions_train = Gompertz_model_cumulative(X_train, a_optimized, b_optimized,c_optimized)
failures_predictions_test = Gompertz_model_cumulative(X_test, a_optimized, b_optimized,c_optimized)
