...
failures_predictions_train = zhang_teng_pham_model_cumulative(X_train, a_optimized, b_optimized, c_optimized, d_optimized, e_optimized)
failures_predictions_test = zhang_teng_pham_model_cumulative(X_test, a_optimized, b_optimized, c_optimized, d_optimized, e_optimized)
